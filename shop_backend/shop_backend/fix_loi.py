...
file_path = r"C:\Users\nhatdaika\AppData\Local\Programs\Python\Python312\Lib\site-packages\django\db\backends\mysql\features.py"
...
"""
    ...
    if "def can_return_columns_from_insert" not in content:
        ...
        print("File nay da duoc sua tu truoc roi, khong can sua lai nua.")
